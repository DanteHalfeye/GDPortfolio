...
### Gameplay Footage
<video controls src="/GDPortfolio/public/assets/NIGHTFALL GAMEPLAY.mp4" title="Title"></video>
### Screenshots
...
I worked primarily as a **Gameplay Programmer and Game Designer**, developing and implementing systems that drive the core gameplay loop.

My work included:

- Designing and implementing the round-based zombie survival loop.
- Programming enemy spawning and wave management.
- Creating systems for player progression and resource collection.
- Implementing power-ups and gameplay upgrades.
- Developing multiplayer gameplay systems.
- Creating interactive gameplay devices and events.
- Balancing difficulty and progression across rounds.
- Debugging and testing multiplayer interactions.

## Gameplay

The core loop is built around surviving each round while making strategic decisions about how to spend the resources earned from defeated enemies.
...
Players can collect resources from gameplay and use them to improve their chances of surviving future rounds.
...
Nightfall gave me practical experience developing multiplayer gameplay systems and designing mechanics around a repeatable gameplay loop.

The project also helped me improve my understanding of game architecture, debugging, balancing, player progression, and designing systems that need to work together rather than existing as isolated mechanics.

## Technologies

**UEFN · Verse · Gameplay Programming · Multiplayer Systems · Game Design**